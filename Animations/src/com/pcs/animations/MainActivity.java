...
public class MainActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSamples = new Sample[]{
             //   new Sample(R.string.app_name, CrossfadeActivity.class),
             //   new Sample(R.string.title_card_flip, CardFlipActivity.class),
               
                new Sample(R.string.zooming, ZoomActivity.class),
                new Sample(R.string.rotating, RotateActivity.class),
                new Sample(R.string.fading, FadeActivity.class),
                new Sample(R.string.bouncing, Bounce.class),
                new Sample(R.string.blinking, BlinkActivity.class),
                new Sample(R.string.sliding, SlidingPageActivity.class),
