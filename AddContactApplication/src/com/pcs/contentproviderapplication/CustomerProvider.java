...
import android.text.TextUtils;
	...
	public class CustomerProvider  extends ContentProvider{
	   ...
	   static final String PROVIDER_NAME = "com.pcs.provider.Customer";
	   static final String URL = "content://"+PROVIDER_NAME+"/customers";
	   /***
	    * "content://com.pcs.provider.Customer/customers";
	    */
	   ...
	   static{
	      ...
	      uriMatcher.addURI(PROVIDER_NAME, "customers/#", CUSTOMER_ID);
	   }
	   ...
	   public Uri insert(Uri uri, ContentValues values) {
	       ...
	       */
	      long rowID = db.insert(	CUSTOMERS_TABLE_NAME, "", values);
	      /** 
	...
	public String getType(Uri uri) {
	 ...
	 @Override
	   public int delete(Uri uri, String selection, String[] selectionArgs) {
	      ...
	      switch (uriMatcher.match(uri)){
	      case CUSTOMERS:
	         count = db.delete(CUSTOMERS_TABLE_NAME, selection, selectionArgs);
	         break;
	      case CUSTOMER_ID:
	         String id = uri.getPathSegments().get(1);
	         count = db.delete( CUSTOMERS_TABLE_NAME, _ID +  " = " + id + 
